<template>
  <div>
    <div class="comics-container">
        <!-- Componente figlio -->
        <CardComicDC v-for="(element, index) in comics" 
        :key="index" :thumb="element.thumb" :series="element.series" :type="element.type"/>
    </div>
    <div class="d-flex justify-content-center">
        <button class="btn-lg btn-primary text-uppercase text-light my-5 ">Load More</button>
    </div>
...
import CardComicDC from './sons/CardComicDC.vue'
